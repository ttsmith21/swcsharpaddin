    ...
    public class SimpleTubeProcessor
    {
        ...
        public bool Process(IModelDoc2 model, ProcessingOptions options)
        {
            ...
            try
            {
                ...
                // TODO(vNext): Map results into CustomProperties via PartData DTO in orchestrator
                return true;
            }
            catch (Exception ex)
            {
        ...
        private TubeGeometry ExtractTubeGeometry(IModelDoc2 model)
        {
            ...
            try
            {
                ...
                foreach (var f in faces)
                {
                    ...
                    if (surf.IsCylinder())
                    {
                        var p = surf.GetCylinderParams2() as double[];
                    ...
                    foreach (var f in faces)
                    {
                        ...
                        foreach (var l in loops)
                        {
                            ...
                            foreach (var e in edges)
                            {
                                ...
                                var vts = edge.GetVertices() as object[]; if (vts == null) continue;
